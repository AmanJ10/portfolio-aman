...
function Contact() {
  ...
  return (
    <>
      <footer className="bg-bg-shade footer">
        <div className="p-10 ml-1 mr-1 footer__container">
          <h2 className="text-center mb-20">Aman Joharapurkar</h2>
          <ul className="flex flex-col justify-center mb-8 md:flex-row items-center gap-6 md:gap-10 md:ml-auto">
            <li>
              <Link
                to="profiles"
                spy={true}
        ...
        <ul className="list-none flex items-center justify-center gap-5 text-decoration-none pb-20 ">
          <li className="inline-flex p-2">
            <a
              href="https://www.linkedin.com/in/aman-joharapurkar/"
            ...
            >
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M12.026 2C6.486 2 2 6.486 2 12.026c0 4.426 2.874 8.168 6.849 9.49.501.09.682-.218.682-.484 0-.238-.01-1.034-.014-1.875-2.781.604-3.369-1.34-3.369-1.34-.456-1.164-1.11-1.475-1.11-1.475-.908-.62.068-.608.068-.608 1.004.07 1.532 1.032 1.532 1.032.893 1.531 2.341 1.089 2.91.832.092-.647.35-1.088.635-1.338-2.22-.252-4.555-1.113-4.555-4.951 0-1.092.39-1.984 1.03-2.682-.104-.253-.447-1.27.097-2.646 0 0 .84-.269 2.75 1.026A9.564 9.564 0 0 1 12 6.802c.85.004 1.705.115 2.505.338 1.91-1.295 2.75-1.026 2.75-1.026.544 1.376.2 2.393.097 2.646.64.698 1.03 1.59 1.03 2.682 0 3.848-2.339 4.696-4.565 4.945.36.31.679.92.679 1.856 0 1.338-.012 2.42-.012 2.748 0 .268.18.58.688.482C19.127 20.19 22 16.45 22 12.026 22 6.486 17.514 2 12.026 2z"
                  fill="black"
                />
              </svg>
            </a>
          ...
          <li className="inline-flex p-2">
            <a
              href="mailto:joharapurkaraman95@gmail.com"
              className="navbar--content"
              target="_blank"
              rel="noreferrer"
            >
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M12 12.713l11.995-8.235V6a2 2 0 0 0-2-2H2.004A2 2 0 0 0 0 6v.478L12 12.713zM23.992 7.538l-12 8.238L0 7.537V18a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V7.538z"
                  fill="black"
                />
              </svg>
            </a>
          ...
          <li className="inline-flex p-2">
            <a
              href="https://www.instagram.com/amanjohara/"
              className="navbar--content"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li className="inline-flex p-2">
            <a
              href="https://twitter.com/Aman_J10"
              className="navbar--content"
              target="_blank"
              rel="noreferrer"
            >
